...
JsKit.Dom.getChildDomNodeByName = function( parentDomNode, nodeNameToLookFor )
{
...
JsKit.Dom.createNodeByPath = function( nodePath )
{
    ...
    parentNode.appendDomChild( node );
}
...
JsKit.Dom.createTextNode = function( nodeValue )
{
...
{
    JsKit.Dom.getNodeById(tagId).innerHTML = tagContent;
}
